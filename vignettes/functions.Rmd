...
The advantage of this approach is that allows sharing parameters across conditions, such as the slope parameter in the following example using the logistic function
